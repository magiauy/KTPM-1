CREATE DATABASE IF NOT EXISTS quanlychothuecanho;
...
CREATE TABLE IF NOT EXISTS Cohabitant (
...
CREATE TABLE IF NOT EXISTS MonthlyRentBill (
...
CREATE TABLE IF NOT EXISTS ViolationTicket (
...
CREATE TABLE IF NOT EXISTS StaffsAccount (
...
VALUES ('APT1', 'B1', '101', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT2', 'B1', '102', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT3', 'B2', '201', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT4', 'B2', '202', 55.5, 2, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT5', 'B3', '301', 70, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT6', 'B3', '302', 75, 3, 2, N'Cơ bản', N'Đã được thuê'),
       ('APT7', 'B4', '401', 60, 2, 1, N'Không có', N'Đã được thuê'),
       ('APT8', 'B4', '402', 65, 2, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT9', 'B5', '501', 80, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT10', 'B5', '502', 90, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT11', 'B3', '303', 75, 3, 2, N'Cơ bản', N'Đã được thuê'),
       ('APT12', 'B4', '403', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT13', 'B4', '404', 65, 2, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT14', 'B5', '503', 80, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT15', 'B5', '504', 90, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT16', 'B1', '103', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT17', 'B1', '104', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT18', 'B2', '202', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT19', 'B2', '203', 55.5, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT20', 'B3', '304', 70, 3, 2, N'Cơ bản', N'Đã được thuê'),
       ('APT21', 'B3', '305', 75, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT22', 'B4', '405', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT23', 'B4', '406', 65, 2, 1, N'Không có', N'Đã được thuê'),
       ('APT24', 'B5', '505', 80, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT25', 'B5', '506', 90, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT26', 'B1', '105', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT27', 'B1', '106', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT28', 'B2', '204', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT29', 'B2', '205', 55.5, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT30', 'B3', '306', 70, 3, 2, N'Không có', N'Đã được thuê');
...
VALUES
    ('MRB1', 'APT1', 'T1', '2024-05-01', 10, 6240000, N'Đã thanh toán'),
    ('MRB31', 'APT1', 'T1', '2024-04-01', 5, 400000, N'Quá hạn'),
    ('MRB33', 'APT1', 'T1', '2024-03-05', 10, 700000, N'Quá hạn'),
    ('MRB35', 'APT1', 'T1', '2024-02-01', 10, 500000, N'Quá hạn'),
    ('MRB36', 'APT1', 'T1', '2024-01-24', 20, 500000, N'Chưa thanh toán'),
    ('MRB37', 'APT2', 'T2', '2024-01-15', 5, 500000, N'Quá hạn'),
    ('MRB38', 'APT2', 'T2', '2024-04-12', 5, 1500000, N'Quá hạn'),
    ('MRB39', 'APT2', 'T2', '2024-02-01', 10, 500000, N'Quá hạn'),
    ('MRB40', 'APT3', 'T3', '2024-04-01', 10, 2000000, N'Quá hạn'),
    ('MRB2', 'APT2', 'T2', '2024-05-01', 10, 7270000, N'Đã thanh toán'),
    ('MRB3', 'APT3', 'T3', '2024-05-01', 10, 5973000, N'Đã thanh toán'),
    ('MRB4', 'APT4', 'T4', '2024-05-01', 10, 6803000, N'Đã thanh toán'),
    ('MRB5', 'APT5', 'T5', '2024-05-01', 10, 8250000, N'Đã thanh toán'),
    ('MRB6', 'APT6', 'T6', '2024-05-01', 10, 11672000, N'Đã thanh toán'),
    ('MRB7', 'APT7', 'T7', '2024-05-01', 10, 14222000, N'Đã thanh toán'),
    ('MRB8', 'APT8', 'T8', '2024-05-01', 10, 11672000, N'Đã thanh toán'),
    ('MRB9', 'APT9', 'T9', '2024-05-01', 10, 13322000, N'Đã thanh toán'),
    ('MRB10', 'APT10', 'T10', '2024-05-01', 10, 16800000, N'Đã thanh toán'),
    ('MRB11', 'APT11', 'T11', '2024-05-01', 10, 13232000, N'Đã thanh toán'),
    ('MRB12', 'APT12', 'T12', '2024-05-01', 10, 16022000, N'Đã thanh toán'),
    ('MRB13', 'APT13', 'T13', '2024-05-01', 10, 13372000, N'Đã thanh toán'),
    ('MRB14', 'APT14', 'T14', '2024-05-01', 10, 16832000, N'Đã thanh toán'),
    ('MRB15', 'APT15', 'T15', '2024-05-01', 10, 19422000, N'Đã thanh toán'),
    ('MRB16', 'APT16', 'T16', '2024-05-01', 10, 12832000, N'Đã thanh toán'),
    ('MRB17', 'APT17', 'T17', '2024-05-01', 10, 15622000, N'Đã thanh toán'),
    ('MRB18', 'APT18', 'T18', '2024-05-01', 10, 12872000, N'Đã thanh toán'),
    ('MRB19', 'APT19', 'T19', '2024-05-01', 10, 13322000, N'Đã thanh toán'),
    ('MRB20', 'APT20', 'T20', '2024-05-01', 10, 16800000, N'Đã thanh toán'),
    ('MRB21', 'APT21', 'T21', '2024-05-01', 10, 13232000, N'Đã thanh toán'),
    ('MRB22', 'APT22', 'T22', '2024-05-01', 10, 16022000, N'Đã thanh toán'),
    ('MRB23', 'APT23', 'T23', '2024-05-01', 10, 13372000, N'Đã thanh toán'),
    ('MRB24', 'APT24', 'T24', '2024-05-01', 10, 16832000, N'Đã thanh toán'),
    ('MRB25', 'APT25', 'T25', '2024-05-01', 10, 19422000, N'Đã thanh toán'),
    ('MRB26', 'APT26', 'T26', '2024-05-01', 10, 12832000, N'Đã thanh toán'),
    ('MRB27', 'APT27', 'T27', '2024-05-01', 10, 15622000, N'Đã thanh toán'),
    ('MRB28', 'APT28', 'T28', '2024-05-01', 10, 12872000, N'Đã thanh toán'),
    ('MRB29', 'APT29', 'T29', '2024-05-01', 10, 13322000, N'Đã thanh toán'),
    ('MRB30', 'APT30', 'T30', '2024-05-01', 10, 16800000, N'Đã thanh toán');
...
VALUES
    ('SERVT1', 'MRB1', 'SERV1', 2, 200000, '2024-05-01', ''),
    ('SERVT2', 'MRB1', 'SERV1', 2, 200000, '2024-05-01', ''),
    ('SERVT3', 'MRB1', 'SERV3', 1, 150000, '2024-05-01', 'Xe SH'),
    ('SERVT4', 'MRB2', 'SERV2', 1, 100000, '2024-04-12', N'Yêu cầu ủi đồ nhanh'),
    ('SERVT5', 'MRB3', 'SERV3', 1, 150000, '2024-04-12', ''),
    ('SERVT6', 'MRB4', 'SERV4', 1, 200000, '2024-04-15', N'Yêu cầu kết nối mạng'),
    ('SERVT7', 'MRB5', 'SERV5', 1, 350000, '2024-04-20', ''),
    ('SERVT8', 'MRB1', 'SERV6', 45, 270000, '2024-05-01', ''),
    ('SERVT9', 'MRB1', 'SERV7', 120, 270000, '2024-05-01', ''),
    ('SERVT10', 'MRB6', 'SERV8', 12, 600000, '2024-05-15', ''),
    ('SERVT11', 'MRB2', 'SERV9', 1, 200000, '2024-04-01', ''),
    ('SERVT12', 'MRB1', 'SERV9', 1, 200000, '2024-05-01', ''),
    ('SERVT13', 'MRB1', 'SERV10', 1, 400000, '2024-05-17', N'Yêu cầu nhạc jazz'),
    ('SERVT14', 'MRB1', 'SERV11', 1, 200000, '2024-05-17', ''),
    ...
    ('SERVT17', 'MRB4', 'SERV3', 1, 150000, '2024-04-02', ''),
    ('SERVT18', 'MRB5', 'SERV4', 1, 200000, '2024-04-05', N'Yêu cầu nâng cấp gói internet'),
    ('SERVT19', 'MRB1', 'SERV5', 1, 350000, '2024-04-04', ''),
    ('SERVT20', 'MRB2', 'SERV6', 45, 270000, '2024-04-09', ''),
    ('SERVT21', 'MRB3', 'SERV7', 126, 270000, '2024-04-11', ''),
    ('SERVT22', 'MRB4', 'SERV8', 12, 600000, '2024-04-22', N'Yêu cầu trông trẻ buổi tối'),
    ('SERVT23', 'MRB5', 'SERV9', 1, 200000, '2024-04-24', ''),
    ('SERVT24', 'MRB6', 'SERV10', 1, 400000, '2024-04-12', N'Đặt bàn BBQ 6 người'),
    ('SERVT25', 'MRB7', 'SERV6', 45, 318000, '2024-04-01', ''),
    ('SERVT26', 'MRB7', 'SERV7', 120, 504000, '2024-04-01', ''),
    ('SERVT27', 'MRB8', 'SERV6', 67, 402000, '2024-04-01', ''),
    ('SERVT28', 'MRB8', 'SERV7', 120, 270000, '2024-04-01', ''),
    ('SERVT29', 'MRB9', 'SERV6', 42, 252000, '2024-04-01', ''),
    ('SERVT30', 'MRB9', 'SERV7', 114, 456000, '2024-04-01', ''),
    ('SERVT31', 'MRB10', 'SERV6', 50, 300000, '2024-04-01', ''),
    ('SERVT32', 'MRB10', 'SERV7', 125, 500000, '2024-04-01', ''),
    ('SERVT33', 'MRB11', 'SERV6', 48, 288000, '2024-04-01', ''),
    ('SERVT34', 'MRB11', 'SERV7', 122, 488000, '2024-04-01', ''),
    ('SERVT35', 'MRB12', 'SERV6', 55, 330000, '2024-04-01', ''),
    ('SERVT36', 'MRB12', 'SERV7', 118, 472000, '2024-04-01', ''),
    ('SERVT37', 'MRB13', 'SERV6', 60, 360000, '2024-04-01', ''),
    ('SERVT38', 'MRB13', 'SERV7', 130, 520000, '2024-04-01', ''),
    ('SERVT39', 'MRB14', 'SERV6', 70, 420000, '2024-04-01', ''),
    ('SERVT40', 'MRB14', 'SERV7', 140, 560000, '2024-04-01', ''),
    ('SERVT41', 'MRB15', 'SERV6', 65, 390000, '2024-04-01', ''),
    ('SERVT42', 'MRB15', 'SERV7', 135, 540000, '2024-04-01', ''),
    ('SERVT43', 'MRB16', 'SERV6', 75, 450000, '2024-04-01', ''),
    ('SERVT44', 'MRB16', 'SERV7', 145, 580000, '2024-04-01', ''),
    ('SERVT45', 'MRB17', 'SERV6', 80, 480000, '2024-04-01', ''),
    ('SERVT46', 'MRB17', 'SERV7', 150, 600000, '2024-04-01', ''),
    ('SERVT47', 'MRB18', 'SERV6', 90, 540000, '2024-04-01', ''),
    ('SERVT48', 'MRB18', 'SERV7', 160, 640000, '2024-04-01', ''),
    ('SERVT49', 'MRB19', 'SERV6', 85, 510000, '2024-04-01', ''),
    ('SERVT50', 'MRB19', 'SERV7', 155, 620000, '2024-04-01', ''),
    ('SERVT51', 'MRB20', 'SERV6', 95, 570000, '2024-04-01', ''),
    ('SERVT52', 'MRB20', 'SERV7', 165, 660000, '2024-04-01', ''),
    ('SERVT53', 'MRB21', 'SERV6', 100, 600000, '2024-04-01', ''),
    ('SERVT54', 'MRB21', 'SERV7', 170, 680000, '2024-04-01', ''),
    ('SERVT55', 'MRB22', 'SERV6', 110, 660000, '2024-04-01', ''),
    ('SERVT56', 'MRB22', 'SERV7', 180, 720000, '2024-04-01', ''),
    ('SERVT57', 'MRB23', 'SERV6', 105, 630000, '2024-04-01', ''),
    ('SERVT58', 'MRB23', 'SERV7', 175, 700000, '2024-04-01', ''),
    ('SERVT59', 'MRB24', 'SERV6', 115, 690000, '2024-04-01', ''),
    ('SERVT60', 'MRB24', 'SERV7', 185, 740000, '2024-04-01', ''),
    ('SERVT61', 'MRB25', 'SERV6', 120, 720000, '2024-04-01', ''),
    ('SERVT62', 'MRB25', 'SERV7', 190, 760000, '2024-04-01', ''),
    ('SERVT63', 'MRB26', 'SERV6', 130, 780000, '2024-04-01', ''),
    ('SERVT64', 'MRB26', 'SERV7', 195, 780000, '2024-04-01', ''),
    ('SERVT65', 'MRB27', 'SERV6', 125, 750000, '2024-04-01', ''),
    ('SERVT66', 'MRB27', 'SERV7', 200, 800000, '2024-04-01', ''),
    ('SERVT67', 'MRB28', 'SERV6', 135, 810000, '2024-04-01', ''),
    ('SERVT68', 'MRB28', 'SERV7', 205, 820000, '2024-04-01', ''),
    ('SERVT69', 'MRB29', 'SERV6', 140, 840000, '2024-04-01', ''),
    ('SERVT70', 'MRB29', 'SERV7', 210, 840000, '2024-04-01', ''),
    ('SERVT71', 'MRB30', 'SERV6', 150, 900000, '2024-04-01', ''),
    ('SERVT72', 'MRB30', 'SERV7', 215, 860000, '2024-04-01', '');
