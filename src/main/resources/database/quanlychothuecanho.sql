...
INSERT INTO Apartment (apartmentID, buildingID, area, bedrooms, bathrooms, furniture,status)
VALUES ('APT1', 'B1', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT2', 'B1', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT3', 'B2', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT4', 'B2', 55.5, 2, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT5', 'B3', 70, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT6', 'B3', 75, 3, 2, N'Cơ bản', N'Đã được thuê'),
       ('APT7', 'B4', 60, 2, 1, N'Không có', N'Đã được thuê'),
       ('APT8', 'B4', 65, 2, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT9', 'B5', 80, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT10', 'B5', 90, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT11', 'B3', 75, 3, 2, N'Cơ bản', N'Đã được thuê'),
       ('APT12', 'B4', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT13', 'B4', 65, 2, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT14', 'B5', 80, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT15', 'B5', 90, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT16', 'B1', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT17', 'B1', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT18', 'B2', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT19', 'B2', 55.5, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT20', 'B3', 70, 3, 2, N'Cơ bản', N'Đã được thuê'),
       ('APT21', 'B3', 75, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT22', 'B4', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT23', 'B4', 65, 2, 1, N'Không có', N'Đã được thuê'),
       ('APT24', 'B5', 80, 3, 2, N'Đầy đủ', N'Đã được thuê'),
       ('APT25', 'B5', 90, 3, 2, N'Không có', N'Đã được thuê'),
       ('APT26', 'B1', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT27', 'B1', 60, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT28', 'B2', 50, 1, 1, N'Cơ bản', N'Đã được thuê'),
       ('APT29', 'B2', 55.5, 2, 1, N'Đầy đủ', N'Đã được thuê'),
       ('APT30', 'B3', 70, 3, 2, N'Không có', N'Đã được thuê');
