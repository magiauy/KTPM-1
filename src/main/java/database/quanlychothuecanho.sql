...
VALUES ('APT1', 'B1', '101', 50, 1, 1, 'Basis'),
		('APT2', 'B1', '102', 60, 2, 1, 'Full'),
		('APT3', 'B2', '201', 50, 1, 1, 'Basis'),
		('APT4', 'B2', '202', 55.5, 2, 1, 'Basis'),
		('APT5', 'B3', '301', 70, 3, 2, 'Full'),
		('APT6', 'B3', '302', 75, 3, 2, 'Basis'),
		('APT7', 'B4', '401', 60, 2, 1, 'No'),
		('APT8', 'B4', '402', 65, 2, 1, 'Basis'),
		('APT9', 'B5', '501', 80, 3, 2, 'No'),
		('APT10', 'B5', '502', 90, 3, 2, 'Full'),
		('APT11', 'B3', '303', 75, 3, 2, 'Basis'),
		('APT12', 'B4', '403', 60, 2, 1, 'Full'),
		('APT13', 'B4', '404', 65, 2, 1, 'Basis'),
		('APT14', 'B5', '503', 80, 3, 2, 'No'),
		('APT15', 'B5', '504', 90, 3, 2, 'Full'),
		('APT16', 'B1', '103', 50, 1, 1, 'Basis'),
		('APT17', 'B1', '104', 60, 2, 1, 'Full'),
		('APT18', 'B2', '202', 50, 1, 1, 'Basis'),
		('APT19', 'B2', '203', 55.5, 2, 1, 'Full'),
		('APT20', 'B3', '304', 70, 3, 2, 'Basis'),
		('APT21', 'B3', '305', 75, 3, 2, 'No'),
		('APT22', 'B4', '405', 60, 2, 1, 'Full'),
		('APT23', 'B4', '406', 65, 2, 1, 'No'),
		('APT24', 'B5', '505', 80, 3, 2, 'Full'),
		('APT25', 'B5', '506', 90, 3, 2, 'No'),
		('APT26', 'B1', '105', 50, 1, 1, 'Basis'),
		('APT27', 'B1', '106', 60, 2, 1, 'Full'),
		('APT28', 'B2', '204', 50, 1, 1, 'Basis'),
		('APT29', 'B2', '205', 55.5, 2, 1, 'Full'),
		('APT30', 'B3', '306', 70, 3, 2, 'No');
