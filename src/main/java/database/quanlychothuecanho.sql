...
INSERT INTO MonthlyRentBill (monthlyRentBillID, apartmentID, ten    antID, date, repaymentPeriod, totalPayment, status)
VALUES
    ('MRB1', 'APT1', 'T1', '2024-05-01', 10, 6240000, N'Paid'),
    ('MRB31', 'APT1', 'T1', '2024-04-01', 5, 400000, N'Overdue'),
    ('MRB33', 'APT1', 'T1', '2024-04-05', 10, 700000, N'Overdue'),
    ('MRB35', 'APT1', 'T1', '2024-04-01', 10, 500000, N'Overdue'),
    ('MRB36', 'APT1', 'T1', '2024-04-24', 20, 500000, N'Unpaid'),
    ('MRB37', 'APT2', 'T2', '2024-04-15', 5, 500000, N'Overdue'),
...
VALUES
    ...
    ('SERV3', N'Giữ xe',3000, N'Lần','fixed'),
...
VALUES
    ('SERV1', 'MRB1', 2, 200000, '2024-04-10', NULL),
    ('SERV2', 'MRB2', 1, 100000, '2024-04-12', N'Yêu cầu ủi đồ nhanh'),
    ('SERV3', 'MRB3', 1, 3000, '2024-04-12', NULL),
    ('SERV4', 'MRB4', 1, 200000, '2024-04-15', N'Yêu cầu kết nối mạng'),
    ('SERV5', 'MRB5', 1, 350000, '2024-04-20', NULL),
    ('SERV6', 'MRB1', 45, 270000, '2024-04-01', NULL),
    ('SERV7', 'MRB1', 120, 270000, '2024-04-01', NULL),
    ('SERV8', 'MRB6', 12, 600000, '2024-04-15', NULL),
    ('SERV9', 'MRB2', 1, 200000, '2024-04-01', NULL),
    ('SERV10', 'MRB1', 1, 400000, '2024-03-17', N'Yêu cầu nhạc jazz'),
    ('SERV1', 'MRB6', 1, 100000, '2024-04-12', N'Yêu cầu dọn dẹp phòng khách'),
    ('SERV2', 'MRB3', 2, 200000, '2024-04-14', N'Yêu cầu giặt ủi áo sơ mi'),
    ('SERV3', 'MRB4', 1, 3000, '2024-04-02', NULL),
    ('SERV4', 'MRB5', 1, 200000, '2024-04-05', N'Yêu cầu nâng cấp gói internet'),
    ('SERV5', 'MRB1', 1, 350000, '2024-04-04', NULL),
    ('SERV6', 'MRB2', 45, 270000, '2024-04-09', NULL),
    ('SERV7', 'MRB3', 126, 270000, '2024-04-11', NULL),
    ('SERV8', 'MRB4', 12, 600000, '2024-04-22', N'Yêu cầu trông trẻ buổi tối'),
    ('SERV9', 'MRB5', 1, 200000, '2024-04-24', NULL),
    ('SERV10', 'MRB6', 1, 400000, '2024-04-12', N'Đặt bàn BBQ 6 người'),
    ('SERV6', 'MRB7', 45, 318000, '2024-04-01', NULL),
    ('SERV7', 'MRB7', 120, 504000, '2024-04-01', NULL),
    ('SERV6', 'MRB8', 67, 402000, '2024-04-01', NULL),
    ('SERV7', 'MRB8', 120, 270000, '2024-04-01', NULL),
    ('SERV6', 'MRB9', 42, 252000, '2024-04-01', NULL),
    ('SERV7', 'MRB9', 114, 456000, '2024-04-01', NULL),
    ('SERV6', 'MRB10', 50, 300000, '2024-04-01', NULL),
    ('SERV7', 'MRB10', 125, 500000, '2024-04-01', NULL),
    ('SERV6', 'MRB11', 48, 288000, '2024-04-01', NULL),
    ('SERV7', 'MRB11', 122, 488000, '2024-04-01', NULL),
    ('SERV6', 'MRB12', 55, 330000, '2024-04-01', NULL),
    ('SERV7', 'MRB12', 118, 472000, '2024-04-01', NULL),
    ('SERV6', 'MRB13', 60, 360000, '2024-04-01', NULL),
    ('SERV7', 'MRB13', 130, 520000, '2024-04-01', NULL),
    ('SERV6', 'MRB14', 70, 420000, '2024-04-01', NULL),
    ('SERV7', 'MRB14', 140, 560000, '2024-04-01', NULL),
    ('SERV6', 'MRB15', 65, 390000, '2024-04-01', NULL),
    ('SERV7', 'MRB15', 135, 540000, '2024-04-01', NULL),
    ('SERV6', 'MRB16', 75, 450000, '2024-04-01', NULL),
    ('SERV7', 'MRB16', 145, 580000, '2024-04-01', NULL),
    ('SERV6', 'MRB17', 80, 480000, '2024-04-01', NULL),
    ('SERV7', 'MRB17', 150, 600000, '2024-04-01', NULL),
    ('SERV6', 'MRB18', 90, 540000, '2024-04-01', NULL),
    ('SERV7', 'MRB18', 160, 640000, '2024-04-01', NULL),
    ('SERV6', 'MRB19', 85, 510000, '2024-04-01', NULL),
    ('SERV7', 'MRB19', 155, 620000, '2024-04-01', NULL),
    ('SERV6', 'MRB20', 95, 570000, '2024-04-01', NULL),
    ('SERV7', 'MRB20', 165, 660000, '2024-04-01', NULL),
    ('SERV6', 'MRB21', 100, 600000, '2024-04-01', NULL),
    ('SERV7', 'MRB21', 170, 680000, '2024-04-01', NULL),
    ('SERV6', 'MRB22', 110, 660000, '2024-04-01', NULL),
    ('SERV7', 'MRB22', 180, 720000, '2024-04-01', NULL),
    ('SERV6', 'MRB23', 105, 630000, '2024-04-01', NULL),
    ('SERV7', 'MRB23', 175, 700000, '2024-04-01', NULL),
    ('SERV6', 'MRB24', 115, 690000, '2024-04-01', NULL),
    ('SERV7', 'MRB24', 185, 740000, '2024-04-01', NULL),
    ('SERV6', 'MRB25', 120, 720000, '2024-04-01', NULL),
    ('SERV7', 'MRB25', 190, 760000, '2024-04-01', NULL),
    ('SERV6', 'MRB26', 130, 780000, '2024-04-01', NULL),
    ('SERV7', 'MRB26', 195, 780000, '2024-04-01', NULL),
    ('SERV6', 'MRB27', 125, 750000, '2024-04-01', NULL),
    ('SERV7', 'MRB27', 200, 800000, '2024-04-01', NULL),
    ('SERV6', 'MRB28', 135, 810000, '2024-04-01', NULL),
    ('SERV7', 'MRB28', 205, 820000, '2024-04-01', NULL),
    ('SERV6', 'MRB29', 140, 840000, '2024-04-01', NULL),
    ('SERV7', 'MRB29', 210, 840000, '2024-04-01', NULL),
    ('SERV6', 'MRB30', 150, 900000, '2024-04-01', NULL),
    ('SERV7', 'MRB30', 215, 860000, '2024-04-01', NULL);
